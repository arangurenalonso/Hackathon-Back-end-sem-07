...
class Carrito_Controllers:
    ...
    def agregar_carrito(self):
        ...
        nombre_cliente=self.validar.validar_existencia_campo_valor("_id",id_cliente)['nombres']
        while True:
    ...
    def show_carrito(self):
        try:
            ...
            =========================
            ''')
            print(self.validar.print_table(Lista_carrito, ['cliente_id','nombre_cliente','producto_seleccionado','precio_producto','cantidad_comprada','monto_total']))
    ...
    def editar_carrito(self):
        ...
        try:
            ...
            =========================
            ''')
                print(self.validar.print_table(registro_carrito, ['ID', 'cliente_id','nombre_cliente','producto_seleccionado','precio_producto','cantidad_comprada','monto_total']))
